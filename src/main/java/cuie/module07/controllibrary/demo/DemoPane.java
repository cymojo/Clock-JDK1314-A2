...
public class DemoPane extends BorderPane {
	...
	private void layoutControls() {
		VBox box = new VBox(new NumberRangeControl(SkinType.LINEAR), titleField, valueField, valueLabel, unitField, new Label("min, max Value:"), minValueField, maxValueField, new Label("animated:"), isAnimated);
		box.setSpacing(10);
